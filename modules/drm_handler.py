...
#..............................................................#..................................................................................................................................................................................................................................................................................................................
            ...
            if "pdf" in url and not ("appx" in url or "classx" in url or "static-" in url):
                ...
                try:
                    # 2. Smart Button Logic (Bkt99/Utkarsh ke liye Chrome button)
                    if any(x in url for x in ["cwmediabkt99", "utkarshapp"]):
                        ...
                        await bot.send_message(chat_id=channel_id, text=f"📄 **Manual Download**\n\n**Name:** `{namef}`", reply_markup=button)
                        count += 1
                        continue 

                    # 3. Direct Download Logic (Safe for SelectionWay)
                    ...
                    if response.status_code == 200:
                        ...
                        # Note: cc1 variable caption logic ke baad define hota hai, ensure alignment
                        await bot.send_document(chat_id=channel_id, document=file_path, caption=f"**File Title :** `{namef}.pdf`")
                        os.remove(file_path)
                        count += 1
                        continue
                    else:
                        ...
                        if os.path.exists(f"{namef}.pdf"):
                            await bot.send_document(chat_id=channel_id, document=f"{namef}.pdf", caption=f"**File Title :** `{namef}.pdf`")
            ...
            # --- NEW ADDITION ---
                ...
                url, contentId = url.split('&', 1) # Split only on the first '&'
                
                headers = {
                    'host': 'api.classplusapp.com',
                    'x-access-token': f'{cptoken}', # Changed to cptoken to match your existing variables   
                    'accept-language': 'EN',
                    'api-version': '18',
            ...
            # --------------------
                ...
                url = f"https://itsgolu-cp-api.vercel.app/itsgolu?url={url}@ITSGOLU_OFFICIAL&user_id={8102112566}"
            ...
            # --- APPX & CLASSX VIDEO SERVER BYPASS (FIXED) ---
                ...
                if "*" in url:
                    ...
                    url = f"{base_url.split('?')[0].replace('https://static-db.classx.co.in', 'https://appxcontent.kaxa.in')}*{key}"
                else:
                ...
                if "*" in url:
                    base_url, key = url.split("*", 1)
                    url = f"{base_url.split('?')[0].replace('https://static-db-v2.classx.co.in', 'https://appx-content-v2.classx.co.in')}*{key}"
                else:
            ...
            # --- FIX: Default Fallback for all other video links ---
            else:
                # Agar koi condition match nahi hui (jaise unacademy ya koi aur), toh ye chalega
                cmd = f'yt-dlp -o "{name}.mp4" --external-downloader aria2c --external-downloader-args "aria2c:-x 16 -s 16 -k 1M" "{url}"'
